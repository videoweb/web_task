...
<div id="container">
  ...
  <li><a href="/first_web/outside.MenuServlet?b_id=6&l_id=0" id="nav_current"><span>娱乐</span></a></li>
  ...
  <div class="nav_son">
  <ul>
  <li><a href="/first_web/outside.MenuServlet?b_id=6&l_id=0">全部</a></li>
  <li><a href="/first_web/outside.MenuServlet?b_id=6&l_id=1">动物圈</a></li>
  <li><a href="/first_web/outside.MenuServlet?b_id=6&l_id=2"><strong>美食</strong></a></li>
  <li><a href="/first_web/outside.MenuServlet?b_id=6&l_id=3">生活娱乐</a></li>
  </ul>
  </div>
  </div>
