...
function function2(){
	window.location.href="/first_web/register.html";
}
</script>
...
<div>
	<% 
		...
		if(info.equals("2"))
		{
			out.print("<h1><center>恭喜您注册成功!</center></h1>");
		}else if(info.equals("3"))
			out.print("<h1><center>注册异常，请返回重新注册或返回首页!</center></h1>");
		else
		{
			out.print("<h1><center>注册失败，该账号已被注册，请返回重新注册或返回首页!</center></h1>");
		}
	%>
<center>
	<table>
		<tr>
			...
			<td><input type="button" id=2 value="重新注册" onClick=function2()></td>
		</tr>
	</table>
</center>
</div>
